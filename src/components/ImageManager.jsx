...
const categories = ['Studio', 'Fashion', 'Outdoor', 'Swimwear', 'Maternity/Baby', 'Graduation', 'Sports', 'B&W', 'Proposal/Wedding']
      ...
      <div className="sticky top-0 z-50 bg-ink/95 backdrop-blur border-b border-cream/5">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button onClick={onBack} aria-label="Back to site" className="text-cream/40 hover:text-gold transition-colors">
